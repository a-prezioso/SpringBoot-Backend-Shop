...
public class ArticoliController {
	...
	private Double getPriceArt(String CodArt, String IdList, String Header)
	{
		...
		Double Prezzo = (IdList.length() > 0) ? 
				priceClient.getPriceArt(Header, CodArt, IdList) : priceClient.getDefPriceArt(Header, CodArt);
	...
	public ResponseEntity<?> createArt(@Valid @RequestBody Articoli articolo, BindingResult bindingResult)
		...
		logger.info("Salviamo l'articolo con codice " + articolo.getCodArt() + articolo.getDescrizione());
		...
		responseNode.put("code", HttpStatus.OK.toString());
		responseNode.put("message", "L'articolo " + articolo.getCodArt() + " è Stato Inserito Con Successo");
	...
	public ResponseEntity<?> updateArt(@Valid @RequestBody Articoli articolo, BindingResult bindingResult)
		...
		responseNode.put("code", HttpStatus.OK.toString());
		responseNode.put("message", "L'articolo " + articolo.getCodArt() + " è Stato Modificato Con Successo");
